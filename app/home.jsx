...
export default function HomeScreen() {
  ...
  const buttons = [
    ...
    {
      route: '/timer',
      image: require('../assets/images/bo_reportv2.png'), // TODO: cambiar por imagen del timer
      marginBottom: -20,
    },
  ];
